...
app = FastAPI(title="Forex Capture Service", version="1.0.0")
...
from services.forex_systemB_capture.api.routes import router
app.include_router(router, prefix="/api/forex-systemB-capture")
