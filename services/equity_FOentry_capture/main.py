...
app = FastAPI(title="Equity FOentry Capture Service", version="1.0.0")
...
from services.equity_FOentry_capture.api.routes import router
app.include_router(router, prefix="/api/equity-FOentry-capture")
